...
export function PlatformShell({
  ...
  useEffect(() => {
    try {
      const cookie = document.cookie.includes("rugsignal_session");
      setHasToken(cookie);
    } catch {
      setHasToken(false);
    }
        ...
        <header className="sticky top-0 z-40 border-b border-[rgba(59,130,246,0.16)] bg-[rgba(2,6,23,0.8)] backdrop-blur-md">
          <div className="mx-auto flex w-full max-w-[1600px] flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6 md:h-16 md:flex-nowrap md:py-0 lg:px-10">
            ...
            <div className="flex w-full flex-wrap items-center gap-3 md:w-auto md:justify-end">
              ...
              <a
                className="flex items-center gap-1.5 rounded-lg border border-[rgba(59,130,246,0.2)] bg-[rgba(59,130,246,0.06)] px-3 py-2 text-sm font-medium text-slate-300 transition-colors hover:bg-[rgba(59,130,246,0.12)] hover:text-slate-100"
              ...
              {hasToken ? (
                <button
                  className="rounded-lg border border-[rgba(59,130,246,0.2)] bg-[rgba(59,130,246,0.06)] px-3 py-2 text-sm font-medium text-slate-400 transition-colors hover:bg-red-500/10 hover:text-red-400"
